...
const CLOUDINARY_UPLOAD_PRESET = 'lrf8hrqv';
...
module.exports =  (req,res)=>{
	...
	const coverFile = path.resolve(__dirname,'../public/posts/home/newProductsContent/1',([cover.name]+'.'+'jpg') )
	const firstFile = path.resolve(__dirname,'../public/posts/home/newProductsContent/1',([first.name]+'.'+'jpg'))
	const secondFile = path.resolve(__dirname,'../public/posts/home/newProductsContent/1',([second.name]+'.'+'jpg'))
	const thirdFile = path.resolve(__dirname,'../public/posts/home/newProductsContent/1',([third.name]+'.'+'jpg'))
	const fourthFile = path.resolve(__dirname,'../public/posts/home/newProductsContent/1',([fourth.name]+'.'+'jpg'))
	const fifthFile = path.resolve(__dirname,'../public/posts/home/newProductsContent/1',([fifth.name]+'.'+'jpg'))
	 									...
	 									cloudinary.v2.uploader.unsigned_upload(fourthFile, CLOUDINARY_UPLOAD_PRESET, (err, fourth_result)=>{
	 										...
	 										fifth.mv(fifthFile, (error)=>{
	 											...
	 											cloudinary.v2.uploader.unsigned_upload(fifthFile, CLOUDINARY_UPLOAD_PRESET, (err, fifth_result)=>{
	 												if(err) res.redirect('/error')
	 												newProductsContent.updateOne({sr:1},{$set :
