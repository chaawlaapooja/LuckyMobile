...
const CLOUDINARY_UPLOAD_PRESET = 'lmzvqc7x';
...
module.exports =  (req,res)=>{
	...
	const coverFile = path.resolve(__dirname,'../public/posts/home/ramContent/2',([cover.name]+'.'+'jpg') )
	const firstFile = path.resolve(__dirname,'../public/posts/home/ramContent/2',([first.name]+'.'+'jpg'))
	const secondFile = path.resolve(__dirname,'../public/posts/home/ramContent/2',([second.name]+'.'+'jpg'))
	const thirdFile = path.resolve(__dirname,'../public/posts/home/ramContent/2',([third.name]+'.'+'jpg'))
	const fourthFile = path.resolve(__dirname,'../public/posts/home/ramContent/2',([fourth.name]+'.'+'jpg'))
	const fifthFile = path.resolve(__dirname,'../public/posts/home/ramContent/2',([fifth.name]+'.'+'jpg'))
