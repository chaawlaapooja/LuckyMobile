...
const CLOUDINARY_UPLOAD_PRESET = 'del9pjdo';
...
module.exports =  (req,res)=>{
	...
	const coverFile = path.resolve(__dirname,'../public/posts/home/screenContent/2',([cover.name]+'.'+'jpg') )
	const firstFile = path.resolve(__dirname,'../public/posts/home/screenContent/2',([first.name]+'.'+'jpg'))
	const secondFile = path.resolve(__dirname,'../public/posts/home/screenContent/2',([second.name]+'.'+'jpg'))
	const thirdFile = path.resolve(__dirname,'../public/posts/home/screenContent/2',([third.name]+'.'+'jpg'))
	const fourthFile = path.resolve(__dirname,'../public/posts/home/screenContent/2',([fourth.name]+'.'+'jpg'))
	const fifthFile = path.resolve(__dirname,'../public/posts/home/screenContent/2',([fifth.name]+'.'+'jpg'))
	 										...
	 										fifth.mv(fifthFile, (error)=>{
	 											...
	 											cloudinary.v2.uploader.unsigned_upload(fifthFile, CLOUDINARY_UPLOAD_PRESET, (err, fifth_result)=>{
	 												...
	 												if(cover_result.secure_url==='' || first_result.secure_url==='' || second_result.secure_url==='' || third_result.secure_url==='' || fourth_result.secure_url==='' || fifth_result.second_result==='')
	 													res.redirect('/error')
	 												screenContent.updateOne({sr:2},{$set :
