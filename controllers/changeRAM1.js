...
const CLOUDINARY_UPLOAD_PRESET = 'sgfyd3fg';
...
module.exports =  (req,res)=>{
	...
	const coverFile = path.resolve(__dirname,'../public/posts/home/ramContent/1',([cover.name]+'.'+'jpg') )
	const firstFile = path.resolve(__dirname,'../public/posts/home/ramContent/1',([first.name]+'.'+'jpg'))
	const secondFile = path.resolve(__dirname,'../public/posts/home/ramContent/1',([second.name]+'.'+'jpg'))
	const thirdFile = path.resolve(__dirname,'../public/posts/home/ramContent/1',([third.name]+'.'+'jpg'))
	const fourthFile = path.resolve(__dirname,'../public/posts/home/ramContent/1',([fourth.name]+'.'+'jpg'))
	const fifthFile = path.resolve(__dirname,'../public/posts/home/ramContent/1',([fifth.name]+'.'+'jpg'))
