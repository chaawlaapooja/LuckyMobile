...
const CLOUDINARY_UPLOAD_PRESET = 'grvqn8wf';
...
module.exports =  (req,res)=>{
	...
	const coverFile = path.resolve(__dirname,'../public/posts/home/newProductsContent/3',([cover.name]+'.'+'jpg') )
	const firstFile = path.resolve(__dirname,'../public/posts/home/newProductsContent/3',([first.name]+'.'+'jpg'))
	const secondFile = path.resolve(__dirname,'../public/posts/home/newProductsContent/3',([second.name]+'.'+'jpg'))
	const thirdFile = path.resolve(__dirname,'../public/posts/home/newProductsContent/3',([third.name]+'.'+'jpg'))
	const fourthFile = path.resolve(__dirname,'../public/posts/home/newProductsContent/3',([fourth.name]+'.'+'jpg'))
	const fifthFile = path.resolve(__dirname,'../public/posts/home/newProductsContent/3',([fifth.name]+'.'+'jpg'))
	 										...
	 										fifth.mv(fifthFile, (error)=>{
	 											...
	 											cloudinary.v2.uploader.unsigned_upload(fifthFile, CLOUDINARY_UPLOAD_PRESET, (err, fifth_result)=>{
	 												...
	 												if(cover_result.secure_url==='' || first_result.secure_url==='' || second_result.secure_url==='' || third_result.secure_url==='' || fourth_result.secure_url==='' || fifth_result.second_result==='')
	 													res.redirect('/error')
	 												newProductsContent.updateOne({sr:3},{$set :
